...
const EXACT_ZH_TO_EN: Record<string, string> = {
  ...
  "导出中...": "Exporting...",
  "导入中...": "Importing...",
  "订阅备份已导出，共 {{count}} 条订阅": "Subscription backup exported, {{count}} subscriptions included",
  "订阅备份已导入，共恢复 {{count}} 条订阅": "Subscription backup imported, {{count}} subscriptions restored",
  "订阅备份已导入，共追加 {{count}} 条订阅": "Subscription backup imported, {{count}} subscriptions appended",
  "导入文件不是有效的 JSON": "Import file is not valid JSON",
  "导入文件格式不正确，缺少 version / exported_at / subscriptions 字段": "Import file format is invalid: missing version / exported_at / subscriptions",
  "确认使用备份覆盖当前全部订阅？此操作会替换现有订阅。": "Use this backup to replace all current subscriptions? This will overwrite existing subscriptions.",
  "确认导入备份中的 {{count}} 条订阅？现有订阅会保留，导入内容将追加到当前列表。": "Import {{count}} subscriptions from the backup? Existing subscriptions will be kept and imported items will be appended.",
  "节点池": "Node Pool",
  "导出节点": "Export Nodes",
  "导出选中（{{count}}）": "Export Selected ({{count}})",
  "已导出 {{count}} 个节点订阅链接": "Exported subscription links for {{count}} nodes",
  "复制节点": "Copy Nodes",
  "复制选中（{{count}}）": "Copy Selected ({{count}})",
  "已复制 {{count}} 个节点订阅链接到剪贴板": "Copied subscription links for {{count}} nodes to clipboard",
  "当前浏览器不支持剪贴板写入": "Current browser does not support clipboard write",
  "节点导出内容不是有效的 Base64 文本": "Node export content is not valid Base64 text",
  ...
  "已删除 {{count}} 条订阅": "Deleted {{count}} subscriptions",
  "确认删除选中的 {{count}} 条订阅？关联节点会被清理。": "Delete the selected {{count}} subscriptions? Related nodes will be cleaned.",
  "删除规则": "Delete Rule",
  "请求": "Request",
  "响应": "Response",
  "平台": "Platform",
